...
FOUNDATION_EXPORT NSString *K4LThumbnailDirectory(void);
FOUNDATION_EXPORT NSString *K4LTemporaryDirectory(void);
FOUNDATION_EXPORT NSString *K4LDraftDirectory(void);
FOUNDATION_EXPORT NSString *K4LDatabasePath(void);
FOUNDATION_EXPORT NSString *K4LPreferencesPath(void);
FOUNDATION_EXPORT NSString *K4LPendingSendPath(void);
